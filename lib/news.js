...
const ANWEISUNG_SAMMELN = `Du prüfst für ein Kickbase-Analysewerkzeug, ob es zu Bundesliga-Spielern Neuigkeiten der letzten ${TAGE_ZURUECK} Tage gibt.

WICHTIG — arbeite sparsam: Suche NICHT nach jedem Spieler einzeln.
Nutze stattdessen **Sammel- und Übersichtsseiten**, die viele Spieler auf
einmal abdecken, zum Beispiel:
- die Ausfall-/Verletzten- und Sperrenlisten von ligainsider, kicker und
  transfermarkt.de
- Kaderlisten und Verletzungsübersichten der betroffenen Vereine
- aktuelle Spieltags- und Aufstellungsvorschauen

Zwei bis drei gut gewählte Suchen auf solchen Übersichten reichen für die
ganze Liste. Gleiche die Treffer anschließend gegen die Spielernamen ab.

Melde nur, was du dort tatsächlich findest: Verletzung, Sperre,
Ausfallzeit, Rückkehr ins Training, Startelf oder Bank, Wechselgerüchte.
Zu den allermeisten Spielern steht dort nichts — das ist der Normalfall
